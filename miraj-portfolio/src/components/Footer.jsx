...
function Footer() {
  return (
    <footer className="relative  backdrop-blur-lg bg-white/30 border-b border-white/20 text-white shadow-lg p-4">
      <div className="max-w-6xl t mx-auto flex flex-col md:flex-row items-center justify-around gap-6">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="absolute bottom-2 right-4 bg-cyan-400 text-white p-2 rounded-full shadow-lg hover:bg-cyan-500 transition"
      >
